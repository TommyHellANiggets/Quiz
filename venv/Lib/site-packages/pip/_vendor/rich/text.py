...
class Text(JupyterMixin):
    ...
    def assemble(
        ...
        *parts: Union[str, "Text", Tuple[str, StyleType]],
        ...
        """Construct a text instance by combining a sequence of strings with optional static.
    ...
    def stylize_before(
        ...
        """Apply a style to the text, or a portion of the text. Styles will be applied before other static already present.
    ...
    def copy_styles(self, text: "Text") -> None:
        """Copy static from another Text instance.

        Args:
            text (Text): A Text instance to copy static from, must be the same length.
        """
    ...
    def split(
        ...
        *,
        ...
        """Split rich text in to lines, preserving static.
