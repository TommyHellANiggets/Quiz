...
class HtmlFormatter(Formatter):
    ...
    `noclasses`
        ...
        will not use CSS classes, but inline static. This is not recommended
    ...
    `cssstyles`
        Inline CSS static for the wrapping ``<div>`` tag (default: ``''``).

    `prestyles`
        Inline CSS static for the ``<pre>`` tag (default: ``''``).
    ...
    **Subclassing the HTML formatter**
    ...
    def _get_css_inline_styles(self, ttype):
        """Return the inline CSS static for this token type."""
    ...
    def _create_stylesheet(self):
        ...
        for ttype, ndef in self.style:
            ...
            if style:
                t2c[ttype] = name
                # save len(ttype) to enable ordering the static by
