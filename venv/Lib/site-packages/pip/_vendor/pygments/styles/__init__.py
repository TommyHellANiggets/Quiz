...
#: A dictionary of built-in static, mapping style names to
#: ``'submodule::classname'`` strings.
#: This list is deprecated. Use `pygments.static.STYLES` instead
...
def get_style_by_name(name):
    """
    Return a style class by its short name. The names of the builtin static
    are listed in :data:`pygments.static.STYLE_MAP`.
    ...
    if name in _STYLE_NAME_TO_MODULE_MAP:
        ...
        for found_name, style in find_plugin_styles():
            if name == found_name:
                return style
        # perhaps it got dropped into our static package
        builtin = ""
        mod = 'pygments.static.' + name
...
def get_all_styles():
    """Return a generator for all static by name, both builtin and plugin."""
